...
$(function () {
    ...
    $("#to_country").combobox();
    $("#to_airport").combobox();
    $("#from_airport").combobox();
    $("#airliner").combobox();
    $("#addr_country").combobox();
    $(".custom-combobox-input").css('border', '1px solid #CFD3D4');
    $(".custom-combobox-input").height('15px');
    $(".custom-combobox-input").attr('placeholder', 'Type to search');
});
$("#weight_unit").css('width', '50px');
$("#length_unit").css('width', '50px');
$("#volume_unit").css('width', '50px');
$("#height_unit").css('width', '50px');
$("#width_unit").css('width', '50px');
$("#size_unit").css('width', '50px');

$.get("http://ipinfo.io", function (response) {
    if ($("#user_id").length > 0) {
    var str = $("#user_id").val();
    var userid = str.replace("XX", response.country);
    $("#user_id").val(userid);
    }
}, "jsonp");
$.get("http://ipinfo.io", function (response) {
    
    if ($("#user_name").length > 0) {var str = $("#user_name").val();
        var userid = str.replace("XX", response.country);
