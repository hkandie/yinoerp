...
/**
 * This is the base-model class for table "address_reference".
 *
 ...
 */
abstract class AddressReference extends \yii\db\ActiveRecord
{
    ...
    /**
     * @inheritdoc
     * @return \app\models\query\AddressReferenceQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\query\AddressReferenceQuery(get_called_class());
    }
