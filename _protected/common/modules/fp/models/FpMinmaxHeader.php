...
/**
 * This is the model class for table "{{%fp_minmax_header}}".
 *
 ...
 */
class FpMinmaxHeader extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['org_id', 'planning_horizon_days', 'created_by', 'last_update_by'], 'integer'],
            [['status'], 'string'],
            [['creation_date', 'last_update_date'], 'safe'],
            [['plan_name', 'demand_source'], 'string', 'max' => 25],
