...
/**
 * This is the model class for table "{{%fp_minmax_suggestion_v}}".
 *
 ...
 * @property string $minmax_multibin_number
 * @property string $minmax_multibin_size
 * @property string $multibin_minmax_quantity
 * @property string $forecast
 * @property string $forecast_description
 * @property integer $fp_minmax_demand_id
 ...
 */
class FpMinmaxSuggestionV extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['org_id', 'planning_horizon_days', 'item_id_m', 'saftey_stock_quantity', 'lead_time', 'saftey_stock_days', 'fix_days_supply', 'multibin_fix_days_supply', 'minmax_multibin_number', 'fp_minmax_demand_id', 'plan_id', 'demand_item_id_m', 'toplevel_demand_item_id_m', 'created_by', 'last_update_by'], 'integer'],
            [['item_id_m', 'plan_id', 'created_by', 'last_update_by'], 'required'],
            [['total_demand', 'avg_daily_demand', 'minimum_quantity', 'maximum_quantity', 'minmax_multibin_size', 'multibin_minmax_quantity'], 'number'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'multibin_minmax_quantity' => Yii::t('app', 'Multibin Minmax Quantity'),
            'forecast' => Yii::t('app', 'Forecast'),
            'forecast_description' => Yii::t('app', 'Forecast Description'),
            'fp_minmax_demand_id' => Yii::t('app', 'Fp Minmax Demand ID'),
