...
/**
 * This is the model class for table "{{%fp_minmax_demand_v}}".
 *
 ...
 */
class FpMinmaxDemandV extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['org_id', 'planning_horizon_days', 'fp_minmax_demand_id', 'plan_id', 'item_id_m', 'demand_item_id_m', 'toplevel_demand_item_id_m', 'created_by', 'last_update_by'], 'integer'],
