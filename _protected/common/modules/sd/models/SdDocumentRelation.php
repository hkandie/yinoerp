...
/**
 * This is the model class for table "{{%sd_document_relation}}".
 *
 ...
 */
class SdDocumentRelation extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['module_name', 'currency_code'], 'unique', 'targetAttribute' => ['module_name', 'currency_code'], 'message' => 'The combination of Module Name and Currency Code has already been taken.'],
            [['price_list'], 'unique'],
        ];
    }
