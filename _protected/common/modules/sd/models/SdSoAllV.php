...
/**
 * This is the model class for table "{{%sd_so_all_v}}".
 *
 ...
 */
class SdSoAllV extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['bu_org_id', 'document_type', 'ar_customer_id', 'customer_name', 'customer_number', 'line_number', 'item_description', 'line_status', 'item_number', 'uom_id', 'item_status', 'org', 'shipping_org_id', 'created_by', 'creation_date', 'last_update_by', 'last_update_date'], 'required'],
            ...
            [['doc_currency', 'so_status', 'customer_number', 'line_type', 'line_status', 'staging_subinventory'], 'string', 'max' => 25],
