...
/**
 * This is the model class for table "am_planned_wo".
 *
 ...
 */
class AmPlannedWo extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['am_asset_id', 'activity_item_id_m', 'parent_wo_id', 'org_id', 'wip_accounting_group_id', 'reference_bom_item_id_m', 'bom_exploded_cb', 'routing_exploded_cb', 'reference_routing_item_id_m', 'department_id', 'build_sequence', 'scheduling_priority', 'created_by', 'last_update_by', 'company_id'], 'integer'],
