...
/**
 * This is the model class for table "{{%prj_budget_line}}".
 *
 * @property string $prj_budget_line_id
 ...
 */
class PrjBudgetLine extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['prj_budget_header_id', 'prj_project_header_id', 'prj_project_line_id', 'prj_resource_line_id', 'uom_id', 'created_by', 'last_update_by', 'company_id'], 'integer'],
            [['prj_project_header_id', 'created_by', 'last_update_by'], 'required'],
