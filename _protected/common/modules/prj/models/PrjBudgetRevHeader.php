...
/**
 * This is the model class for table "{{%prj_budget_rev_header}}".
 *
 * @property string $prj_budget_rev_header_id
 ...
 */
class PrjBudgetRevHeader extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['prj_budget_header_id', 'prj_project_header_id', 'version_number', 'version_name', 'created_by', 'last_update_by'], 'required'],
            [['prj_budget_header_id', 'prj_project_header_id', 'prj_project_line_id', 'version_number', 'current_cb', 'original_cb', 'baselined_cb', 'created_by', 'last_update_by', 'company_id'], 'integer'],
            ...
            [['prj_project_header_id', 'version_number', 'baselined_cb'], 'unique', 'targetAttribute' => ['prj_project_header_id', 'version_number', 'baselined_cb'], 'message' => 'The combination of Prj Project Header ID, Version Number and Baselined Cb has already been taken.'],
        ];
    }
