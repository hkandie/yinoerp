...
/**
 * This is the model class for table "{{%qa_ce_quality_rating}}".
 *
 * @property integer $qa_ce_quality_rating_id
 ...
 * @property string $qa_ce_quality_rating_value
 * @property integer $company_id
 */
class QaCeQualityRating extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['qa_ce_quality_rating_value'], 'string', 'max' => 10],
            [['qa_ce_quality_rating_value', 'reference_key_name', 'reference_key_value'], 'unique', 'targetAttribute' => ['qa_ce_quality_rating_value', 'reference_key_name', 'reference_key_value'], 'message' => 'The combination of Reference Key Name, Reference Key Value and Qa Ce Quality Rating Value has already been taken.'],
        ];
    }
    ...
    {
        return [
            'qa_ce_quality_rating_id' => Yii::t('app', 'Qa Ce Quality Rating ID'),
            ...
            'qa_ce_quality_rating_value' => Yii::t('app', 'Qa Ce Quality Rating Value'),
