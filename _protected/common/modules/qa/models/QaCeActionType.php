...
/**
 * This is the model class for table "{{%qa_ce_action_type}}".
 *
 * @property integer $qa_ce_action_type_id
 ...
 * @property string $qa_ce_action_type_value
 * @property integer $company_id
 */
class QaCeActionType extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['qa_ce_action_type_value'], 'string', 'max' => 10],
            [['qa_ce_action_type_value', 'reference_key_name', 'reference_key_value'], 'unique', 'targetAttribute' => ['qa_ce_action_type_value', 'reference_key_name', 'reference_key_value'], 'message' => 'The combination of Reference Key Name, Reference Key Value and Qa Ce Action Type Value has already been taken.'],
        ];
    }
    ...
    {
        return [
            'qa_ce_action_type_id' => Yii::t('app', 'Qa Ce Action Type ID'),
            ...
            'qa_ce_action_type_value' => Yii::t('app', 'Qa Ce Action Type Value'),
