...
/**
 * This is the model class for table "{{%sys_process_flow_action_value}}".
 *
 ...
 */
class SysProcessFlowActionValue extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%sys_process_flow_action_value}}';
    }
