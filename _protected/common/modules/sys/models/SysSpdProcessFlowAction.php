...
/**
 * This is the model class for table "{{%sys_spd_process_flow_action}}".
 *
 * @property integer $sys_spd_process_flow_action_id
 ...
 */
class SysSpdProcessFlowAction extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%sys_spd_process_flow_action}}';
    }
    ...
    {
        return [
            [['sys_spd_header_id', 'sys_process_flow_line_id', 'action_number', 'created_by', 'last_update_by'], 'required'],
            [['sys_spd_header_id', 'sys_process_flow_line_id', 'action_number', 'user_id', 'action_user_id', 'object_primary_id', 'created_by', 'last_update_by', 'company_id'], 'integer'],
            ...
            [['sys_spd_header_id', 'sys_process_flow_line_id'], 'unique', 'targetAttribute' => ['sys_spd_header_id', 'sys_process_flow_line_id'], 'message' => 'The combination of Sys Spd Header ID and Sys Process Flow Line ID has already been taken.'],
        ];
    }
    ...
    {
        return [
            'sys_spd_process_flow_action_id' => Yii::t('app', 'Sys Spd Process Flow Action ID'),
