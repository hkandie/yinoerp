...
/**
 * This is the model class for table "{{%sys_pd_process_flow_action_value}}".
 *
 * @property integer $sys_pd_process_flow_action_value_id
 ...
 */
class SysPdProcessFlowActionValue extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%sys_pd_process_flow_action_value}}';
    }
    ...
    {
        return [
            'sys_pd_process_flow_action_value_id' => Yii::t('app', 'Sys Pd Process Flow Action Value ID'),
