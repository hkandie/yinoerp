...
/**
 * This is the model class for table "{{%sys_extra_field_instance}}".
 *
 * @property integer $sys_extra_field_instance_id
 * @property integer $sys_extra_field_id
 ...
 */
class SysExtraFieldInstance extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%sys_extra_field_instance}}';
    }
    ...
    {
        return [
            [['sys_extra_field_id', 'reference_key_name', 'reference_key_value', 'created_by', 'last_update_by'], 'required'],
            [['sys_extra_field_id', 'reference_key_value', 'control_uom', 'active_cb', 'display_weight', 'created_by', 'last_update_by', 'company_id'], 'integer'],
            [['list_values'], 'string'],
            ...
            [['sys_extra_field_id', 'reference_type', 'reference_key_name', 'reference_key_value'], 'unique', 'targetAttribute' => ['sys_extra_field_id', 'reference_type', 'reference_key_name', 'reference_key_value'], 'message' => 'The combination of Sys Extra Field ID, Reference Type, Reference Key Name and Reference Key Value has already been taken.'],
        ];
    }
    ...
    {
        return [
            'sys_extra_field_instance_id' => Yii::t('app', 'Sys Extra Field Instance ID'),
            'sys_extra_field_id' => Yii::t('app', 'Sys Extra Field ID'),
