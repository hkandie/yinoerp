...
/**
 * This is the model class for table "ap_po_matching_v".
 *
 ...
 * @property string $receiving_open_quantity
 ...
 * @property string $invoicing_open_quantity
 ...
 */
class ApPoMatchingV extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['po_header_id', 'bu_org_id', 'supplier_id', 'supplier_site_id', 'payment_term_id', 'supplier_number', 'supplier_site_number', 'po_line_id', 'po_line_number', 'item_id_m', 'uom_id', 'po_detail_id', 'shipment_number', 'receving_org_id', 'subinventory_id', 'locator_id', 'received_quantity', 'accepted_quantity', 'delivered_quantity', 'invoiced_quantity', 'paid_quantity', 'charge_ac_id', 'accrual_ac_id', 'budget_ac_id', 'ppv_ac_id', 'created_by', 'last_update_by'], 'integer'],
            [['bu_org_id', 'po_type', 'supplier_id', 'supplier_site_id', 'currency', 'doc_currency', 'po_status', 'payment_term_id', 'shipment_number', 'need_by_date', 'created_by', 'creation_date', 'last_update_by', 'last_update_date'], 'required'],
            [['header_amount', 'line_quantity', 'unit_price', 'line_price', 'gl_line_price', 'gl_tax_amount', 'tax_amount', 'quantity', 'receiving_open_quantity', 'invoicing_open_quantity'], 'number'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'receiving_open_quantity' => Yii::t('app', 'Receiving Open Quantity'),
            ...
            'invoicing_open_quantity' => Yii::t('app', 'Invoicing Open Quantity'),
