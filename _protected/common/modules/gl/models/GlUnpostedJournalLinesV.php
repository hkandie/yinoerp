...
/**
 * This is the model class for table "{{%gl_unposted_journal_lines_v}}".
 *
 * @property string $combination
 * @property integer $code_combination_id
 * @property string $period_name
 * @property integer $coa_id
 * @property string $sum_total_cr
 * @property string $sum_total_dr
 * @property string $sum_total_ac_dr
 * @property string $sum_total_ac_cr
 ...
 */
class GlUnpostedJournalLinesV extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%gl_unposted_journal_lines_v}}';
    }
    ...
    public function rules()
    {
        return [
            ...
            [['sum_total_cr', 'sum_total_dr', 'sum_total_ac_dr', 'sum_total_ac_cr'], 'number'],
            [['status'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'sum_total_cr' => Yii::t('app', 'Sum Total Cr'),
            'sum_total_dr' => Yii::t('app', 'Sum Total Dr'),
            'sum_total_ac_dr' => Yii::t('app', 'Sum Total Ac Dr'),
            'sum_total_ac_cr' => Yii::t('app', 'Sum Total Ac Cr'),
