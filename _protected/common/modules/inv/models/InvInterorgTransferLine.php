...
/**
 * This is the model class for table "{{%inv_interorg_transfer_line}}".
 *
 ...
 */
class InvInterorgTransferLine extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%inv_interorg_transfer_line}}';
    }
    ...
    {
        return [
            [['inv_interorg_transfer_header_id', 'transaction_type_id', 'from_subinventory_id', 'transaction_quantity', 'created_by', 'creation_date', 'last_update_by', 'last_update_date'], 'required'],
            [['inv_interorg_transfer_header_id', 'transaction_type_id', 'line_number', 'from_subinventory_id', 'from_locator_id', 'item_id_m', 'uom_id', 'to_subinventory_id', 'to_locator_id', 'transaction_quantity', 'created_by', 'last_update_by', 'company_id'], 'integer'],
            [['received_quantity'], 'number'],
            [['creation_date', 'last_update_date'], 'safe'],
            [['revision_name'], 'string', 'max' => 10],
            [['item_description', 'description', 'lot_number', 'serial_number'], 'string', 'max' => 256],
