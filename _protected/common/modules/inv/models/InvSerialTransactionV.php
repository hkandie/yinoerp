...
/**
 * This is the model class for table "{{%inv_serial_transaction_v}}".
 *
 ...
 */
class InvSerialTransactionV extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%inv_serial_transaction_v}}';
    }
    ...
    {
        return [
            [['inv_serial_transaction_id', 'inv_transaction_id', 'inv_serial_number_id', 'transaction_type_id', 'org_id', 'item_id_m', 'uom_id', 'lot_number_id', 'document_id', 'po_header_id', 'po_line_id', 'po_detail_id', 'sd_so_line_id', 'from_org_id', 'from_subinventory_id', 'to_org_id', 'to_subinventory_id', 'from_locator_id', 'to_locator_id'], 'integer'],
            [['inv_transaction_id', 'inv_serial_number_id'], 'required'],
            [['serial_number', 'item_number', 'reference_key_name', 'reference_key_value'], 'string', 'max' => 50],
