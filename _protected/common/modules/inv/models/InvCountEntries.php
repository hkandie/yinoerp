...
/**
 * This is the model class for table "{{%inv_count_entries}}".
 *
 ...
 */
class InvCountEntries extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['inv_count_schedule_id', 'item_id_m', 'uom_id', 'org_id', 'subinventory_id', 'locator_id', 'adjustment_ac_id', 'created_by', 'last_update_by', 'company_id'], 'integer'],
            ...
            [['reason', 'reference', 'counted_by', 'description'], 'string', 'max' => 256],
            [['inv_count_schedule_id'], 'unique'],
        ];
    }
