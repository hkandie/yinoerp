...
use common\modules\backup\models\UploadForm;
...
class DefaultController extends Controller {
    ...
    protected function getPath() {
        if (isset($this->module->path))
            ...
            $this->_path = Yii::$app->basePath . '/site/data/_backup/';
    ...
    public function actionCreate() {
        ...
        $searchForm = new \yii\base\DynamicModel([
            'tablename'
        ]);
        if (Yii::$app->request->isPost) {
            ...
            $formDetails = Yii::$app->request->post('DynamicModel'); 
            $details="";
            echo var_dump($formDetails)."<br/><br/><br/><br/>";
            foreach ($formDetails as $i => $formDetail) {
                echo var_dump($formDetail)." ".($i);
