...
/**
 * This is the model class for table "{{%po_requisition_all_v}}".
 *
 ...
 */
class PoRequisitionAllV extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['po_requisition_type', 'po_requisition_number', 'requisition_status', 'payment_term', 'line_type', 'item_number', 'ship_to_inventory', 'order_number', 'ship_to_org'], 'string', 'max' => 50],
