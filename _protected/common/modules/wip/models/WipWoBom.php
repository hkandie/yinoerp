...
/**
 * This is the model class for table "{{%wip_wo_bom}}".
 *
 * @property string $wip_wo_bom_id
 ...
 */
class WipWoBom extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['wip_wo_header_id', 'bom_sequence', 'component_item_id_m', 'usage_quantity', 'created_by', 'creation_date', 'last_update_by', 'last_update_date'], 'required'],
            [['wip_wo_header_id', 'bom_sequence', 'routing_sequence', 'component_item_id_m', 'auto_request_material_cb', 'eco_implemented_cb', 'include_in_cost_rollup_cb', 'supply_sub_inventory', 'supply_locator', 'required_quantity', 'issued_quantity', 'ef_id', 'created_by', 'last_update_by', 'company_id'], 'integer'],
            ...
            [['wip_wo_header_id', 'bom_sequence'], 'unique', 'targetAttribute' => ['wip_wo_header_id', 'bom_sequence'], 'message' => 'The combination of Wip Wo Header ID and Bom Sequence has already been taken.'],
            [['wip_wo_header_id', 'routing_sequence', 'component_item_id_m'], 'unique', 'targetAttribute' => ['wip_wo_header_id', 'routing_sequence', 'component_item_id_m'], 'message' => 'The combination of Wip Wo Header ID, Routing Sequence and Component Item Id M has already been taken.'],
        ];
    }
