...
/**
 * This is the model class for table "{{%pm_process_operation_line}}".
 *
 * @property string $pm_process_operation_line_id
 ...
 */
class PmProcessOperationLine extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return '{{%pm_process_operation_line}}';
    }
    ...
    {
        return [
            [['pm_process_operation_header_id', 'activity_code', 'created_by', 'last_update_by'], 'required'],
            [['pm_process_operation_header_id', 'sequence_dependency_cb', 'breakable_cb', 'material_scheduled_cb', 'created_by', 'last_update_by', 'company_id'], 'integer'],
            [['activity_factror', 'offset_interval'], 'number'],
            [['creation_date', 'last_update_date'], 'safe'],
            [['activity_code'], 'string', 'max' => 25],
            [['description'], 'string', 'max' => 255],
            [['pm_process_operation_header_id', 'activity_code'], 'unique', 'targetAttribute' => ['pm_process_operation_header_id', 'activity_code'], 'message' => 'The combination of Pm Process Operation Header ID and Activity Code has already been taken.'],
        ];
    }
