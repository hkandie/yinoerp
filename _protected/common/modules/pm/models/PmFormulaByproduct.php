...
/**
 * This is the model class for table "{{%pm_formula_byproduct}}".
 *
 * @property string $pm_formula_byproduct_id
 ...
 */
class PmFormulaByproduct extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['allocated_quantity', 'planned_quantity', 'actual_quantity', 'wip_planned_quantity'], 'number'],
    ...
    {
        return [
            'pm_formula_byproduct_id' => Yii::t('app', 'Pm Formula Byproduct ID'),
