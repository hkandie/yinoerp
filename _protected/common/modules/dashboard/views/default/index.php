		...
		<div class="col-md-6 col-sm-6 col-xs-12">
		      <div class="edusec-link-box">
		        ...
		        <div class="edusec-link-box-content">
		          ...
		          <span class="edusec-link-box-number"><?php $msgOfDay = common\modules\dashboard\models\MsgOfDay::find()->where(['is_status'=>0])->count(); echo "Status : ".(($msgOfDay==1) ? "Active" : "Deactive"); ?></span>
		...
		<div class="col-md-6 col-sm-6 col-xs-12">
		      <div class="edusec-link-box">
		        ...
		        <div class="edusec-link-box-content">
		          ...
		          <span class="edusec-link-box-number"><?= common\modules\dashboard\models\Notice::find()->where(['is_status'=>0])->count(); ?></span>
