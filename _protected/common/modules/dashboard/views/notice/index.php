                    ...
                    'columns' => [
                        ...
                        [
                            ...
                            'value' => function ($model) {
                                return (($model->notice_user_type == 'S') ? 'Student' : (($model->notice_user_type == 'E') ? "Employee" : (($model->notice_user_type == 'P') ? "Parent" : "General" ) ));
                            },
                            'filter' => ['S' => 'Student','P' => 'Parent', 'E' => 'Employee', '0' => 'General'],
                        ],
                        [
